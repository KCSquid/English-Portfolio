...
export default function App() {
  return (
    <>
      <div id='intro'>
        <h1 class='title'>English Portfolio of</h1>
        <h1 class='title gradient' id='titleGrad'>Jahvon</h1>
        <p id='titlebottom'><br /><br /><br />Full Stack Developer with a passion for C++ & Website Creation <i class="fa-solid fa-code"></i></p>
      </div>

      <div class='sectionA section'>
      ...
      <div class='sectionF section'>
        <h1 className='gradientGreen'>My Work</h1>
        <img id='storybook' src={storybook}></img>
        <div className='paragraphRight'>
      ...
      <div class='sectionG section'>
        <h1 className='gradientGreen'>The Future</h1>
        <img id='messy' src='https://images.unsplash.com/photo-1562240020-ce31ccb0fa7d?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D'></img>
        <div className='paragraphLeft'>
